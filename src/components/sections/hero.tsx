    ...
    <section className="relative py-20 md:py-28">
      ...
      <div className="container relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <div className="animate-in fade-in slide-in-from-top-8 duration-1000 ease-in-out">
           <h1 className="font-headline text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl animate-shine bg-[linear-gradient(110deg,theme(colors.foreground),45%,theme(colors.primary),55%,theme(colors.foreground))] bg-[length:250%_100%] bg-clip-text text-transparent">
            Building ideas
            <br />
            into reality.
          </h1>
